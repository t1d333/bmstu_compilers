...
/**
 ** \file ./syntax_analyzer/parser/include/parser.h
...
#ifndef YY_YY_SYNTAX_ANALYZER_PARSER_INCLUDE_PARSER_H_INCLUDED
# define YY_YY_SYNTAX_ANALYZER_PARSER_INCLUDE_PARSER_H_INCLUDED
...
#line 55 "./syntax_analyzer/parser/include/parser.h"
...
namespace yy {
#line 195 "./syntax_analyzer/parser/include/parser.h"
  ...
  private:
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_LEFT_PAREN = 4,                        // "("
        S_RIGHT_PAREN = 5,                       // ")"
        S_LEFT_ANGLE_PAREN = 6,                  // "<"
        S_RIGHT_ANGLE_PAREN = 7,                 // ">"
        S_LEFT_CURLY_PAREN = 8,                  // "{"
        S_RIGHT_CURLY_PAREN = 9,                 // "}"
        S_COMMA = 10,                            // ","
        S_COLON = 11,                            // ":"
        S_SEMICOLON = 12,                        // ";"
        S_DOT = 13,                              // "."
        ...
        S_start = 20,                            // start
        S_func = 21,                             // func
        S_func_body = 22,                        // func_body
        S_sentence = 23,                         // sentence
        S_lhs = 24,                              // lhs
        S_condition = 25,                        // condition
        S_result = 26,                           // result
        S_result_part = 27,                      // result_part
        S_pattern = 28,                          // pattern
        S_pattern_part = 29                      // pattern_part
      };
    };
...
switch (yykind)
    ...
    struct symbol_type : basic_symbol<by_kind>
    {
...
#endif
      {
        ...
        YY_ASSERT (tok == token::END
                   || (token::YYerror <= tok && tok <= token::DOT)
                   || tok == 273);
#endif
      }
#if 201103L <= YY_CPLUSPLUS
      ...
      {
#if !defined _MSC_VER || defined __clang__
        YY_ASSERT ((token::STRING <= tok && tok <= token::VAR));
#endif
      }
    };

    /// Build a parser object.
     Parser  (Lexer &lexer_yyarg, Coords *coords_yyarg, std::string *attr_yyarg);
    virtual ~ Parser  ();
    ...
    // Implementation of make_symbol for each token kind.
      ...
      static
      symbol_type
      make_LEFT_ANGLE_PAREN ()
      {
        return symbol_type (token::LEFT_ANGLE_PAREN);
      }
#else
      static
      symbol_type
      ...
      static
      symbol_type
      make_RIGHT_ANGLE_PAREN ()
      {
        return symbol_type (token::RIGHT_ANGLE_PAREN);
      }
#else
      static
      symbol_type
      ...
      static
      symbol_type
      make_LEFT_CURLY_PAREN ()
      {
        return symbol_type (token::LEFT_CURLY_PAREN);
      }
#else
      static
      symbol_type
      ...
      static
      symbol_type
      make_RIGHT_CURLY_PAREN ()
      {
        return symbol_type (token::RIGHT_CURLY_PAREN);
      }
#else
      static
      symbol_type
...
#line 1547 "./syntax_analyzer/parser/include/parser.h"




#endif // !YY_YY_SYNTAX_ANALYZER_PARSER_INCLUDE_PARSER_H_INCLUDED
